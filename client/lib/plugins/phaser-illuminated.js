...
Phaser.Plugin.PhaserIlluminated.prototype._construct = function(){
    ...
    illuminated.Lamp.prototype.mask = function (ctx, arcStart, objects) {
        var center = this.center();
        var c = this._getVisibleMaskCache(center, arcStart, objects);
...
Phaser.Plugin.PhaserIlluminated.prototype._createLamp = function(x, y, config){
    ...
    sprite.refresh = function(arcStart){
        ...
        if(this.lighting){
            ...
            this.lighting.compute(this.bmd.width+0.01, this.bmd.height, arcStart);
            this.lighting.render(this.bmd.ctx, arcStart);
        }else{
            this.lamp.render(this.bmd.ctx,arcStart);
        }
...
Phaser.Plugin.PhaserIlluminated.prototype._createDarkMask = function(illuminatedSprites, color){
    ...
    sprite.refresh = function(arcStart){
        ...
        this.bmd.ctx.clearRect(0, 0, this.bmd.width, this.bmd.height);
        this.darkMask.compute(this.bmd.width, this.bmd.height, arcStart, this.objects);
